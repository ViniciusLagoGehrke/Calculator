    ...
    <div className="w-full h-screen flex justify-center items-center">
      <div className="border rounded p-4">
        ...
        <Row>
          ...
          <Button
            title="/"
            isSelected={isSelected(OPERATIONS.DIVIDE)}
            onClick={() => handleOperatorClick(OPERATIONS.DIVIDE)}
          />
        </Row>
        <Row>
          <Button
          ...
          <Button
            title="*"
            isSelected={isSelected(OPERATIONS.MULTIPLY)}
            onClick={() => handleOperatorClick(OPERATIONS.MULTIPLY)}
          />
        </Row>
        <Row>
          <Button
          ...
          <Button
            title="-"
            isSelected={isSelected(OPERATIONS.SUBTRACT)}
            onClick={() => handleOperatorClick(OPERATIONS.SUBTRACT)}
          />
        </Row>
        <Row>
          <Button
          ...
          <Button
            title="+"
            isSelected={isSelected(OPERATIONS.SUM)}
            onClick={() => handleOperatorClick(OPERATIONS.SUM)}
          />
        </Row>
        <Row>
